Public Class pelanggan
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        Else
            Dim sql
            If Not aksi Then
                sql = "insert into pelanggan values('" & TextBox2.Text & "','" & TextBox3.Text & "','" & TextBox4.Text & "')"
                'MsgBox(sql)
                exc(sql)
                clearForm(GroupBox2)
                ...
                awal()
            Else
                sql = "update pelanggan set nama_pelanggan = '" & TextBox2.Text & "', alamat = '" & TextBox3.Text & "', no_telp = '" & TextBox4.Text & "' where id_pelanggan = " & id
                'MsgBox(sql)
                exc(sql)
                clearForm(GroupBox2)
